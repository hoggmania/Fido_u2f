...
import u2f.crypto.BouncyCastleCrypto;
import u2f.crypto.ChallengeGenerator;
import u2f.crypto.Crypto;
import u2f.crypto.RandomChallengeGenerator;
import u2f.data.DeviceRegistration;
import u2f.data.messages.*;
import u2f.data.messages.key.RawAuthenticateResponse;
import u2f.data.messages.key.RawRegisterResponse;
import u2f.data.messages.key.util.U2fB64Encoding;
...
public class U2fPrimitives {
    ...
    /**
     * @see U2fPrimitives#finishRegistration(RegisterRequest, RegisterResponse, Set)
     */
     ...
     *
     * @see U2fPrimitives#startAuthentication(String, DeviceRegistration, byte[])
     */
    ...
    /**
     * @see U2fPrimitives#finishAuthentication(AuthenticateRequest, AuthenticateResponse, DeviceRegistration, Set)
     */
